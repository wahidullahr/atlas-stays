      ...
      <div className="flex flex-col flex-1 p-5 framer:p-6">
        ...
        <div className="flex gap-2 mt-auto">
          <a
            ...
            className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 framer:py-3 rounded-xl bg-accent text-white text-[13px] framer:text-[14px] font-semibold hover:bg-accent/90 transition-all duration-200"
          >
